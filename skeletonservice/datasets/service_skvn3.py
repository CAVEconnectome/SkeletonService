...
class SkeletonService_skvn3(SkeletonService):
    ...
    def get_cache_contents(
        ...
        if verbose_level_ >= 1:
            SkeletonService.print(f"SkeletonService_skvn3.get_cache_contents: {bucket} {skeleton_version} {rid_prefixes} {limit}")
    ...
    def skeletons_exist(
        ...
        if verbose_level_ >= 1:
            SkeletonService.print(f"SkeletonService_skvn3.skeletons_exist: {bucket} {skeleton_version} {rids}")
    ...
    def get_skeleton_by_datastack_and_rid(
        ...
        if verbose_level_ >= 1:
            SkeletonService.print(f"SkeletonService_skvn3.get_skeleton_by_datastack_and_rid: {datastack_name} {rid} {output_format} {bucket}")
    ...
    def get_skeleton_by_datastack_and_rid_async(
        ...
        if verbose_level_ >= 1:
            SkeletonService.print(f"SkeletonService_skvn3.get_skeleton_by_datastack_and_rid_async: {datastack_name} {rid} {output_format} {bucket}")
    ...
    def get_skeletons_bulk_by_datastack_and_rids(
        ...
        if verbose_level_ >= 1:
            SkeletonService.print(f"SkeletonService_skvn3.get_skeletons_bulk_by_datastack_and_rids: {datastack_name} {rids} {bucket}")
    ...
    def generate_skeletons_bulk_by_datastack_and_rids_async(
        ...
        if verbose_level_ >= 1:
            SkeletonService.print(f"SkeletonService_skvn3.generate_skeletons_bulk_by_datastack_and_rids_async: {datastack_name} {rids} {bucket}")
