...
class SkeletonService_skvn2(SkeletonService):
    def __init__(self):
        super().__init__()
        logger.info("SkeletonService_skvn2 initialized")
    ...
    def get_cache_contents(
        ...
        logger.info(f"SkeletonService_skvn2.get_cache_contents: {bucket} {skeleton_version} {rid_prefixes} {limit}")
    ...
    def skeletons_exist(
        ...
        logger.info(f"SkeletonService_skvn2.skeletons_exist: {bucket} {skeleton_version} {rids}")
    ...
    def get_skeleton_by_datastack_and_rid(
        ...
        logger.info(f"SkeletonService_skvn2.get_skeleton_by_datastack_and_rid: {datastack_name} {rid} {output_format} {bucket}")
    ...
    def get_skeleton_by_datastack_and_rid_async(
        ...
        logger.info(f"SkeletonService_skvn2.get_skeleton_by_datastack_and_rid_async: {datastack_name} {rid} {output_format} {bucket}")
    ...
    def get_skeletons_bulk_by_datastack_and_rids(
        ...
        logger.info(f"SkeletonService_skvn2.get_skeletons_bulk_by_datastack_and_rids: {datastack_name} {rids} {bucket}")
    ...
    def generate_skeletons_bulk_by_datastack_and_rids_async(
        ...
        logger.info(f"SkeletonService_skvn2.generate_skeletons_bulk_by_datastack_and_rids_async: {datastack_name} {rids} {bucket}")
