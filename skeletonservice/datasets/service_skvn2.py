...
class SkeletonService_skvn2(SkeletonService):
    ...
    def get_bulk_skeletons_by_datastack_and_rids(
        ...
        print(f"SkeletonService_skvn2.get_skeleton_by_datastack_and_rid: {datastack_name} {rids} {bucket}")
    ...
    def generate_bulk_skeletons_by_datastack_and_rids_without_retrieval(
        ...
        print(f"SkeletonService_skvn2.generate_bulk_skeletons_by_datastack_and_rids_without_retrieval: {datastack_name} {rids} {bucket}")
